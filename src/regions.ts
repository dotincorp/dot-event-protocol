 ...
 */
export const regionsByCountry: Readonly<Record<string, readonly RegionDefinition[]>> = {
  KR: [
...
const labels = new Map(
  Object.values(regionsByCountry).flatMap((regions) =>
    regions.map((region) => [region.code, region.label] as const)),
);
